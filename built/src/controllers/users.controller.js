            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, users_service_1.default.signup({ email: email, password: password })];
                    case 1:
                        users = _b.sent();
                        res.json(users);
                        return [3 /*break*/, 3];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, email = _a.email, password = _a.password;
                        return [4 /*yield*/, users_service_1.default.login({ email: email, password: password })];
                    case 1:
                        users = _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, users_service_1.default.logout(refreshToken)];
                    case 1:
                        token = _a.sent();
                        res.json(token);
                        return [3 /*break*/, 3];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, users_service_1.default.activate(link)];
                    case 1:
